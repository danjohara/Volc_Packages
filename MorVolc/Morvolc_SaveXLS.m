...
gp = {'Tif File:',morRes.GeneralParams.inputs.tifFile;...
    ...
    'Kringing Interpolation:',morRes.GeneralParams.inputs.interpSurfaces.Kringing==1};
...
if morRes.GeneralParams.inputs.interpSurfaces.Kringing
    szp{hStart+2,3} = morRes.SizeParams.Peak_Height.Kringing;
    szp{vStart+2,3} = morRes.SizeParams.Volume.Kringing;
    szp{haStart+2,3} = morRes.SizeParams.Any_Height.Kringing.Height;
    szp{haStart+2,4} = morRes.SizeParams.Any_Height.Kringing.X;
    szp{haStart+2,5} = morRes.SizeParams.Any_Height.Kringing.Y;
end
...
if morRes.GeneralParams.inputs.interpSurfaces.Kringing
    shp{hbwI+2,3} = morRes.ShapeParams.Height_BasalWidth.Kringing;
end
...
if ~isempty(morRes.CraterParams)
    for i = 1:length(morRes.CraterParams.Crater_Area)
        ...
        if morRes.GeneralParams.inputs.interpSurfaces.Kringing
            cp{cdI+2,3} = morRes.CraterParams.Crater_Depth{i}.Kringing;
            cp{cvI+2,3} = morRes.CraterParams.Crater_Volume{i}.Kringing;
            cp{cdcwI+2,3} = morRes.CraterParams.CraterDepth_CraterWidth{i}.Kringing;
            cp{cdbhI+2,3} = morRes.CraterParams.CraterDepth_BasalHeight{i}.Kringing;
        end
